...
class Config(object):
    ...
    SQL_SERVER = os.environ.get('SQL_SERVER') or 'khangtv4-project1'
    SQL_DATABASE = os.environ.get('SQL_DATABASE') or 'article'
    SQL_USER_NAME = os.environ.get('SQL_USER_NAME') or 'KhangTV4'
    SQL_PASSWORD = os.environ.get('SQL_PASSWORD') or 'Huynhnhu)123'
